...
let package = Package(
    ...
    dependencies: [
        // Pinned to iliasaz/STTextView's `macintora` branch — Macintora
        // consumes this fork transitively and SwiftPM requires the same
        // identity for the shared package.
        .package(url: "https://github.com/iliasaz/STTextView.git", branch: "macintora"),
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                ...
                .target(name: "TreeSitterSQLOrcl"),
                .target(name: "TreeSitterSQLOrclQueries"),
        ...
        .target(name: "TreeSitterSQLOrcl", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterSQLOrclQueries", resources: [.copy("highlights.scm")]),
